...
%>
      <%="<td>"+"欢迎学号为"+sno+"姓名为"+sname+"的同学进入网络192班的电子会议厅！"+"</td>"%>
            ...
            <div id="leftMenu">
                ...
                <ul style="list-style-type: none;font-family: '黑体'; ">
                    <li><a href="startDiscuss.jsp?sno=<%=sno%> " target="iframe_a" style="text-decoration: none;">讨论班级事务</a></li>
                    <li><a href="all_Information.jsp" target="iframe_a" style="text-decoration: none;" >浏览班级事务</a></li>
                    <li><a href="selectInformation.jsp" target="iframe_a" style="text-decoration: none;" >查询班级事务</a></li>
                    <li><a href="updateMyDiscuss.jsp?sno=<%=sno%> " target="iframe_a" style="text-decoration: none;">讨论信息维护</a></li>
                </ul>
            </div>
